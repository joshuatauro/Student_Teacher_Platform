        ...
        <div className="md:grid md:grid-cols-post-layout gap-3 md:gap-0">
          <div className="flex items-center md:flex-col">
            <div className="flex md:flex-col justify-center items-center mr-2 md:mr-0">
              <h1 className="text-mobile-xs md:text-xl mr-1 md:mr-0 font-medium">5</h1>
            ...
            <div className="flex md:flex-col justify-center items-center mr-2 md:mr-0">
              <h1 className="text-mobile-xs md:text-xl mr-1 md:mr-0 font-medium">2</h1>
              <p className='text-mobile-xs md:text-xs md:-mt-1'>answers</p>
            </div>
            </div>
          </div>
          <div className="">
              <h1 to={`/question/${qID}`} className=" text-mobile-sm md:text-[19px] font-normal md:font-normal underline underline-offset-[2px] decoration-1 text-cta dark:text-dark-cta-fade-text">This is the title</h1>
            <p className='text-mobile-xs md:text-[14px] text-gray-700 font-normal dark:text-dark-text'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Maxime quam alias harum sapiente magnam aliquid corrupti. Minima facere exercitationem ipsam explicabo recusandae suscipit inventore aspernatur possimus officiis deserunt, accusamus beatae.</p>
            <div className=" mt-2 justify-between">
              <div className="flex">
                {
                  ['HTML', 'CSS']?.map(name => <Tag tagName={name} />)
                }
              </div>
